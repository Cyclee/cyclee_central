...
//     $('nav#secondary').fadeToggle();
//     $('nav#primary').find('span').toggle();    
// });
    // <span class="nav-toggle nav-close">&#9652;</span>
    // <span class="nav-toggle nav-open">&#9662;</span>
...
$('.commute-location select').on('change', function(){
    xy = $(this).val();
...
$('#signup').ajaxSend(function(event, xhr, settings) {
