...
DEBUG = env['DJANGO_DEBUG'] #get DEBUG from env
...
CACHES = {
    'default': {
        ...
        'LOCATION': "%(host)s:%(port)s:%(db)s" % dict(host=env['DOTCLOUD_CACHE_REDIS_HOST'], 
...
ROOT_URLCONF = 'cycleecarto.urls'

TEMPLATE_DIRS = (
    os.path.join(PROJECT_ROOT, 'cycleecarto/templates/'),
)
...
# CARTODB API
CARTODB_ACCOUNT_NAME = env['CARTODB_ACCOUNT_NAME'] 
